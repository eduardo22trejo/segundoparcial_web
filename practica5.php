...
<body>
	<?php 
		$registros = array(
			array("id" => 1, "nombre" => "Maria", "edad" => 25, "sexo" => "M"),
			array("id" => 2, "nombre" => "paola", "edad" => 35, "sexo" => "M"),
			array("id" => 3, "nombre" => "fabian", "edad" => 55, "sexo" => "F"),
			array("id" => 4, "nombre" => "rocio", "edad" => 19, "sexo" => "F"),
			array("id" => 5, "nombre" => "elena", "edad" => 89, "sexo" => "F"),
